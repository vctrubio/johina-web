            ...
            <div className="options-container">
                <div className="filter-group primary-filters">
                    <div className="select-container category-container">
                        <button ref={categoryButtonRef} className="filter-button" onClick={() => setIsCategoryOpen(!isCategoryOpen)}>
                    ...
                    <div className="select-container location-container">
                        <button ref={locationButtonRef} className="filter-button" onClick={() => setIsLocationOpen(!isLocationOpen)}>
                ...
                <div className="filter-group secondary-filters">
                    <button className="show-titles-btn" onClick={() => setShowTitles(!showTitles)} aria-label="Show Titles">
